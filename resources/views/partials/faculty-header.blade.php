    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('accomplishments*') || Request::is('faculty/accomplishments/folders*') || Request::routeIs('faculty.faculty-accomplishment') ? 'active' : '' }}"
                ...
                <li class="nav-item reports-item">
                    ...
                    <div class="reports-submenu-custom" id="reportsSubmenu">
                        <div class="submenu-content">
                            ...
                            <a class="submenu-item" href="{{ route('admin.reports.admin-hap') }}"
                                style="margin-bottom: 15px;">HAP - TG</a>
                        </div>
                    </div>
                </li>
            </ul>
