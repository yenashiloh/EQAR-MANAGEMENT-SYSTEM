    ...
    <div class="row">
        <div class="col-md-8 col-lg-10 mx-auto">
            <div class="header-container">
                ...
                <a href="{{route ('admin.admin-accomplishment')}}" class="btn btn-danger"><i class="fas fa-arrow-left"></i> Back to previous page</a>
            </div>
        </div>
    </div>
...
<script>
    $('#editFolderModal').on('show.bs.modal', function (event) {
        ...
        modal.find('form').attr('action', '/admin/accomplishments/edit-folder/' + id);
    });
