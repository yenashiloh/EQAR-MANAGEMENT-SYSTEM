...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 col-lg-10 mx-auto">
            <div class="header-container">
                ...
                <a href="{{ route('admin.admin-accomplishment') }}" class="btn btn-danger"><i
                    ...
                    <div class="modal fade" id="addFolderModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form
                                    action="{{ route('admin.accomplishment.class-records.year-semestral.store', ['folder_name_id' => $folder_name_id]) }}"
                                    method="POST">
                        ...
                        <tbody>
                            @foreach ($folders as $folder)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.accomplishments.class-records.view-folders', $folder->year_semestral_id) }}"
    ...
    <script>
        ...
        var modal = $(this);
        modal.find('.modal-body #editFolderName').val(name);
        modal.find('form').attr('action', '/accomplishments/class-records/edit-folder/' + id);
    });
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: $('#delete-form-' + folderId).attr('action'),
                type: 'POST',
                data: $('#delete-form-' + folderId).serialize(),
