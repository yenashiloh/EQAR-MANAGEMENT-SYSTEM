            ...
            <ul>
                ...
                <li class="academic-list course">
                    ...
                    <ul class="sub-menu" id="classroomSubMenu" style="display: none;">
                        {{-- <li><a href="{{ route('admin.accomplishments.class-records.admin-class-records') }}">Class
                                Record</a></li> --}}
                                @foreach ($folders as $folder)
                                @if ($folder->main_folder_name == 'Classroom Management')
                                    <li>
                                        <a href="{{ route('admin.accomplishment.class-records.year-semestral', ['folder_name_id' => $folder->folder_name_id]) }}">
                                            {{ $folder->folder_name }}
                                        </a>
                                    </li>
                                @endif
