                ...
                <ul>
                    ...
                    <li class="academic-list course">
                        ...
                        <ul class="sub-menu" id="classroomSubMenu" style="display: none;">
                            <li><a href="{{ route('faculty.accomplishments.faculty-class-records') }}">Class Record</a></li>
                            <li><a href="{{ route('faculty.accomplishments.faculty-class-list')}}">Classlist</a></li>
