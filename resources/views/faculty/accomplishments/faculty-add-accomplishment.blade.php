    ...
    <div class="row">
        <div class="col-md-8 col-lg-10 mx-auto">
            <div class="header-container">
                ...
                <a href="{{ route('faculty.accomplishments.faculty-class-records') }}" class="btn btn-danger">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="courseTitle" name="courseTitle" class="form-control mb-3" required>
                                </div>
                                <div class="col-md-12">
                                    <label for="courseCode" class="form-label">Course Code<span style="color: red;">*</span></label>
                                    <input type="text" id="courseCode" name="courseCode" class="form-control mb-3" required>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="date" id="dateFinished" name="dateFinished" class="form-control mb-3" required>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="supportingDocuments" name="supportingDocuments" class="form-control mb-3">
                                </div>
                                <div class="col-md-12">
