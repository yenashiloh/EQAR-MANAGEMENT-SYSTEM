    ...
    <div class="row">
        <div class="col-md-8 col-lg-10 mx-auto">
            <div class="header-container">
                ...
                <a href="{{ route('faculty.accomplishments.faculty-class-list') }}" class="btn btn-danger">
        ...
        <div class="col-md-8 col-lg-10 mx-auto">
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <form action="{{ route('faculty.accomplishments.class-list-store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="container">
                            <div class="row mb-3">
                                <div class="col-md-12">
