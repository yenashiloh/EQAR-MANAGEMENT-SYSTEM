...
<body>
    <div class="bg-container d-flex justify-content-center align-items-center vh-100">
        ...
        <div class="card-login text-center mx-auto p-4">
            ...
            <h5 class="text-role mb-3">Login as Faculty</h5>
            <div class="btn-container">
                <form action="{{ route('login.post') }}" method="POST">
                    ...
                    <button type="submit" value="login" class=" mb-3 custom-button">Sign in</button>
                    <p class=" mb-4">Don't have an account? <a href="{{ route('faculty-sign-up') }}" class="text-primary" style="text-decoration: underline;">Sign Up</a></p>
                </form>
            </div>
        </div>
    </div>
